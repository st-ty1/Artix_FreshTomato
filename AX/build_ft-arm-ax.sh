...
patch -i  $FT_PATCHES_DIR/AX/iperf3_configure.ac.patch $FT_REPO_DIR/release/src/router/iperf3/configure.ac

# new: curl
patch -i  $FT_PATCHES_DIR/AX/curl_configure.ac.patch $FT_REPO_DIR/release/src/router/curl/configure.ac

patch -i  $FT_PATCHES_DIR/AX/config_Makefile.patch $FT_REPO_DIR/release/src/router/config/Makefile
