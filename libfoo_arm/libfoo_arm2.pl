...
genSO("${root}/usr/lib/libglib-1.2.so.0", "${router}/glib/.libs/libglib-1.2.so.0.0.10", "${stripshared}");
...
genSO("${root}/usr/lib/libpng16.so.16", "${router}/libpng/.libs/libpng16.a", "${stripshared}", "-L${router}/zlib");
