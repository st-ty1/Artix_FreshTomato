...
8.) Copy 910-cfns-fix-mismatch-in-gnu_inline-attributes.patch of this repo in packages/gcc/5.3.0 of your local buildroot-2016.02 directory.
9.) Copy uClibc-0.9.32.1-gen_wctype.patch (and for versions with NPTL also 0071-Fix-libgcc_s_resume-issue.patch) of this repo in packages/uclibc/0.9.32.1 of your local buildroot-2016.02 directory.
10.) Generate a package of the linux sources in FT repos (file name has to be "linux-2.6.tar.xz") and place package into dl_save folder of your local buildroot-2016.02 directory
...
11.) Start the building process with "make".
