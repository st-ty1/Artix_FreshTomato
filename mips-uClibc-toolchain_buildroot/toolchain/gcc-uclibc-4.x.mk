...
ifeq ($(BR2_GCC_SUPPORTS_FINEGRAINEDMTUNE),y)
	...
	CXXFLAGS_FOR_TARGET="-Os -pipe -mips32 -mtune=mips32 -funit-at-a-time" all-gcc
endif
	touch $@
...
$(gcc_initial) $(HOST_DIR)/usr/bin/$(REAL_GNU_TARGET_NAME)-gcc: $(GCC_BUILD_DIR1)/.compiled
	PATH=$(TARGET_PATH) $(MAKE) -C $(GCC_BUILD_DIR1) \
		CFLAGS_FOR_TARGET="-fgnu89-inline -Os -pipe -mips32 -mtune=mips32 -funit-at-a-time" \
		CXXFLAGS_FOR_TARGET="-fgnu89-inline -Os -pipe -mips32 -mtune=mips32" install-gcc
	touch $(gcc_initial)
...
ifeq ($(BR2_GCC_SUPPORTS_FINEGRAINEDMTUNE),y)
	...
	$(MAKE) -C $(GCC_BUILD_DIR2)\
		CFLAGS_FOR_TARGET="-Os  -std=gnu89 -pipe -mips32 -mtune=mips32 -funit-at-a-time" \
		CXXFLAGS_FOR_TARGET="-Os -pipe -mips32 -mtune=mips32 -funit-at-a-time" all-gcc
endif
	touch $@
...
ifeq ($(BR2_GCC_SUPPORTS_FINEGRAINEDMTUNE),y)
	...
	PATH=$(TARGET_PATH) $(MAKE) -C $(GCC_BUILD_DIR2) \
		CFLAGS_FOR_TARGET="-Os  -std=gnu89 -pipe -mips32 -mtune=mips32 -funit-at-a-time" \
		CXXFLAGS_FOR_TARGET="-Os -pipe -mips32 -mtune=mips32 -funit-at-a-time" install-gcc
endif
...
$(GCC_BUILD_DIR3)/.compiled: $(GCC_BUILD_DIR3)/.configured
	$(GCC_CONF_ENV) $(MAKE) -C $(GCC_BUILD_DIR3) \
		CFLAGS_FOR_TARGET="-Os -pipe -mips32 -mtune=mips32 -funit-at-a-time" \
		CXXFLAGS_FOR_TARGET="-Os -pipe -mips32 -mtune=mips32 -funit-at-a-time" all
	touch $@
...
$(GCC_BUILD_DIR3)/.installed: $(GCC_BUILD_DIR3)/.compiled
	PATH=$(TARGET_PATH) $(MAKE) \
		-C $(GCC_BUILD_DIR3) \
		CFLAGS_FOR_TARGET="-Os -pipe -mips32 -mtune=mips32 -funit-at-a-time" \
		CXXFLAGS_FOR_TARGET="-Os -pipe -mips32 -mtune=mips32 -funit-at-a-time" install
...
$(GCC_BUILD_DIR4)/.configured: $(GCC_BUILD_DIR4)/.prepared
	(cd $(GCC_BUILD_DIR4); rm -rf config.cache; \
		...
		GCC_FOR_TARGET="$(TARGET_CC)" \UCLIBC_HAS_LOCALE
		$(SOFT_FLOAT_CONFIG_OPTION) \
		$(GCC_WITH_ABI) $(GCC_WITH_ARCH) $(GCC_WITH_TUNE) $(GCC_WITH_CPU) \
		$(DISABLE_LARGEFILE) \
		$(EXTRA_GCC_CONFIG_OPTIONS) \
