...
cp -v $FT_PATCHES_DIR/minidlna/101-tomato-specific_mod.patch $FT_REPO_DIR/release/src-rt-6.x.4708/router/patches/minidlna/101-tomato-specific.patch
patch -i $FT_PATCHES_DIR/minidlna/Makefile_minidlna.patch $FT_REPO_DIR/release/src-rt-6.x.4708/router/Makefile
