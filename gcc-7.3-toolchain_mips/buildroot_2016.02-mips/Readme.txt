1.) Download and extract sources of buildroot-2016.02 (https://buildroot.org/downloads/buildroot-2016.02.tar.bz2) into a new subfolder buildroot-2016.02_mips of your $HOME directory (e.g. $HOME/buildroot-2016.02). From now, this is the path of local buildroot-2016.02 directory.
...
5.) Download buildroot-2018.02 sources (https://buildroot.org/downloads/buildroot-20108.02.tar.bz2), extract them into a temporary folder and copy the subfolders package/gcc 
	and packages/binutils into the /package subfolder of your local buildroot-2016.02 directory 
6.) Replace uclibc.mk in package/uclibc subfolder of your local buildroot-2016.02 directory by uclibc.mk of this package (XLOCALE)
7.) Replace uClibc-0.9.32.config in package/uclibc subfolder of your local buildroot-2016.02 directory by uClibc-0.9.32.config of this package (or by uClibc-0.9.32.config_nptl, if you want to build a nptl-version) of this package). 
...
9.) Generate a package of the linux sources in FT repos (file name has to be "linux-2.6.tar.xz"), create subfolder dl_save in your local buildroot-2016.02 directory and place package into dl_save folder.
...
5a.) Download buildroot-2018.02 sources (https://buildroot.org/downloads/buildroot-20108.02.tar.bz2), extract them into a temporary folder and copy the subfolders 
...
5b.) copy gcc.mk of this repo into /package/gcc subfolder of your local buildroot-2016.02 directory