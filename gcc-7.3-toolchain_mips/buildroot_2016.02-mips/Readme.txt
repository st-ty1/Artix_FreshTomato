1.) Download and extract sources of buildroot-2016.02 (https://buildroot.org/downloads/buildroot-2016.02.tar.bz2) into a new subfolder buildroot-2016.02_mips of your $HOME directory (e.g. $HOME/buildroot-2016.02_mips). From now, this is the path of local buildroot-2016.02 directory.
