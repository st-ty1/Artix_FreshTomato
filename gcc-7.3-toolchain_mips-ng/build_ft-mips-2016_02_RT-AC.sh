...
FT_PATCHES_DIR=$HOME/Artix_FreshTomato/gcc-7.3-toolchain_mips-ng

## path to mips-toolchain with gcc 7.3 and binutils 2.28.1
FT_TOOLCHAIN_DIR=$HOME/buildroot-2016.02_mips_7.3-ng/output/host

export PATH=$FT_REPO_DIR/tools/brcm/K26/hndtools-mipsel-uclibc-7.3-ng/usr/bin:$PATH
RT_VERS="src-rt-6.x"
...
mkdir -p $FT_REPO_DIR/tools/brcm/K26/hndtools-mipsel-uclibc-7.3-ng/usr
cp -rf $FT_TOOLCHAIN_DIR/usr/* $FT_REPO_DIR/tools/brcm/K26/hndtools-mipsel-uclibc-7.3-ng/usr
...
## router/httpd
patch -i $FT_PATCHES_DIR/ctype.h.patch $FT_REPO_DIR/tools/brcm/K26/hndtools-mipsel-uclibc-7.3-ng/usr/mipsel-brcm-linux-uclibc/sysroot/usr/include/ctype.h
